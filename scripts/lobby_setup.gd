...
var steam_id: int = 0
var steam_username: String = "Gabe Newell"

@onready var open_lobby_list: Button = $VBoxContainer/OpenLobbyList
...
func make_p2p_handshake() -> void:
	...
	#Steam.sendP2PPacket(0, {"message": "handshake", "from": steam_id}, Steam.P2P_SEND_RELIABLE)
